...
import { Mail, Instagram, MapPin, Check, AlertCircle } from 'lucide-react';
...
export default function ContactView() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.message) {
      setError('Por favor, completá tu nombre y tu mensaje.');
      return;
    }
          ...
          <AnimatePresence mode="wait">
            {!isSubmitted ? (
              ...
              >
                ...
                <h3 className="font-serif text-2xl text-on-surface">Te abrimos WhatsApp</h3>
